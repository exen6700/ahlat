...
export default function IletisimPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      action: 'mailto:info@ahlattasarim.com'
    },
    {
      icon: MapPin,
      title: 'Adres',
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        {info.action ? (
                          <a
                            href={info.action}
                            className="text-turquoise-600 font-medium mb-1 hover:text-turquoise-700 transition-colors duration-200"
                          >
                            {info.content}
                          </a>
                        ) : (
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Ofisimizi ziyaret etmek için haritayı kullanabilirsiniz.
            </p>
          </motion.div>
          ...
          >
            <div className="h-96 bg-gradient-to-br from-turquoise-100 to-blue-100 flex items-center justify-center">
              <div className="text-center">
                <MapPin className="w-16 h-16 text-turquoise-600 mx-auto mb-4" />
